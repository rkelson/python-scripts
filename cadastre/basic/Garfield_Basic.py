...
from __addressParcels_Garfield import addressParcels_Garfield
...
county = 'Garfield'
fips = '49017'
recorder = '1-435-676-1112'
url = ''
# ******
path = r'L:\agrc\users\rkelson\Cadastre\Basic\2020'
coPath = os.path.join(path, county)
# ******
parcels = r'L:\agrc\data\county_obtained\Garfield\Garfield20191231.gdb\Parcels'
parcelFld = 'PARCELID'
# ******
...
def p1():
    ...
    addressParcels_Garfield(newParcels, parcelFld)
