# Grand County parcels
# this code uses the address points from SDE
# a new field needs to be added to join parcels to address points
# and their PAREL_ID field is Text 9 so more fun here
#   PARCEL_ID2 = !PARCEL_ID![:2]+"-0"+!PARCEL_ID![2:5]+"-"+!PARCEL_ID![-4:]
...
from __addressParcels_Grand import addressParcels_Grand
...
county = 'Grand'
fips = '49019'
recorder = '1-435-259-1331'
url = 'http://www.grandcountyutah.net/790/Parcel-Viewer-Map'
# ******
path = r'L:\agrc\users\rkelson\Cadastre\Basic\2020'
coPath = os.path.join(path, county)
# ******
parcels = r'L:\agrc\data\county_obtained\Grand\GrandCo_20200129.gdb\GC_Parcel'
parcelFld = 'COINSParcelID'
# ******
