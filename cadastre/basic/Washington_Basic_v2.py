# Uses input data from L:\\ . No longer downloading the data from their Distributed Geodatabase.
# I use what Michael Foulger pulls down
...
sys.exit('populate CoUpdates data for WashCo & fix bookmarks')

county = 'Washington'
fips = '49053'
recorder = '1-435-634-5709'
url = 'http://geo.washco.utah.gov/Html5Viewer/?viewer=RecordersOffice'
# ******
path = r'L:\agrc\users\rkelson\Cadastre\Basic\2020'
coPath = os.path.join(path, county)
# ******
parcels = r'L:\agrc\data\county_obtained\Washington\Washington20200630.gdb\WashCo_Parcels'
parcelFld = 'TAX_ID'
# ******
