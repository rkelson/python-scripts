...
# from __addressParcels_Generic import addressParcels_Generic
...
county = 'BoxElder'
fips = '49003'
recorder = '1-435-734-3391'
url = 'https://gis.boxeldercounty.org/'
# ******
path = r'L:\agrc\users\rkelson\Cadastre\Basic\2020'
coPath = os.path.join(path, county)
# ******
parcels = r'L:\agrc\data\county_obtained\BoxElder\BoxElder_20200319.gdb\Box_Elder_Tax_Parcels'
parcelFld = 'SCHNO'
# ******
