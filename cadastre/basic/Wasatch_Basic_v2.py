...
from __addressParcels_Wasatch import addressParcels_Wasatch
...
county = 'Wasatch'
fips = '49051'
recorder = '1-435-657-3214'
url  = 'http://wasatch.maps.arcgis.com/apps/webappviewer/index.html?id=fe65f93c14a84f44814a81f97fa0fa5b'
# ******
path = r'L:\agrc\users\rkelson\Cadastre\Basic\2020'
coPath = os.path.join(path, county)
# ******
parcels = r'L:\agrc\data\county_obtained\Wasatch\WasatchCounty20191231.gdb\WC_PARCEL'
parcelFld = 'PARCEL_ID'
# ******
...
def p1():
    ...
    addressParcels_Wasatch(newParcels, parcelFld)
